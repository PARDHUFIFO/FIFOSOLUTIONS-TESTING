...
WebUI.selectOptionByIndex(findTestObject('LOGIN/select_Type of login Employee Vendor Benchsales job Seeker Training'), 4)

WebUI.click(findTestObject('LOGIN/button_Login'))

WebUI.delay(3)

WebUI.click(findTestObject('TRAINING/Job seeker acc/Page_Fifo jobseekeraccount/a_Logout'))
